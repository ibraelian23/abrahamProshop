...
const ProfileScreen = ({location,history,match}) => {
    ...
    const clickHandler = async (e) => {
        setTimeout(() => {dispatch(getOrderDetails(e.view.location.pathname.split("/")[2]))},200) 
    }
    ...
    return (
        <Row>
            ...
            <Col md={9}>
                <h2>My Orders</h2>
                {loadingOrders?<Loader/>:errorOrders?<Message varitant="danger">{errorOrders}</Message>
                :(
                        ...
                        <tr key={order._id}>
                            ...
                            <td>
                                <LinkContainer to={`/order/${order._id}`}>
                                    <Button onClick={clickHandler} className="btn-sm" variant="light">Details</Button>
                                </LinkContainer>
                            </td>
                        </tr>
                    ))}
