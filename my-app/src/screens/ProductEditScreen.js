...
const ProductEditScreen = ({match,history}) => {
    ...
    return (
        <>
            ...
            {errorUpdate && <Message varitant="danger">{errorUpdate}</Message>}
            {loading ? <Loader/> : error ? <Message varitant="danger">{error}</Message> : (
                ...
                <Form.Group controlId="category">
                    ...
                    <Form.Control type="text" placeholder="Enter category url" value={category} onChange={(e)=>setCategory(e.target.value)} >
                    </Form.Control>
                </Form.Group>

                <Form.Group controlId="description">
                    <Form.Label>Description</Form.Label>
                    <Form.Control type="text" placeholder="Enter description url" value={description} onChange={(e)=>setDescription(e.target.value)} >
                    </Form.Control>
                </Form.Group>
